    ...
    <div className="space-y-6">
      ...
      <div className="p-6 rounded-3xl bg-gradient-to-r from-navy-900 via-slate-900 to-navy-950 border border-ocean-500/25 shadow-xl flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        ...
        <div className="flex flex-wrap items-center gap-2">
          <button
            ...
            className="px-3 py-1.5 rounded-xl bg-rose-500/20 hover:bg-rose-500/30 text-rose-300 border border-rose-500/30 text-xs font-mono font-bold transition-all flex items-center gap-1.5"
          >
          ...
          <button
            ...
            className="px-3 py-1.5 rounded-xl bg-emerald-500/20 hover:bg-emerald-500/30 text-emerald-300 border border-emerald-500/30 text-xs font-mono font-bold transition-all flex items-center gap-1.5"
          >
      ...
      <form onSubmit={handleSubmit} className="p-6 rounded-3xl glass-panel space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-3">
          {/* Cargo Quantity */}
          <div>
            <label className="text-[11px] font-semibold text-slate-300 block mb-1">Cargo Parcel (MT)</label>
            <input
              type="number"
          ...
          {/* Origin */}
          <div>
            <label className="text-[11px] font-semibold text-slate-300 block mb-1">Loading Port</label>
            <select
              value={form.origin}
        ...
        result && (
          <div className="space-y-6">
            ...
            {!result.isFeasible ? (
              ...
              <div className="p-6 rounded-3xl bg-gradient-to-r from-emerald-950/40 via-slate-900 to-navy-950 border border-emerald-500/40 shadow-xl space-y-4">
              ...
              <div className="space-y-4">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                  ...
                  <div className="text-xs font-mono text-slate-400">
                    Showing <strong className="text-white">{result.alternatives.length}</strong> calculated options
                  </div>
                </div>
